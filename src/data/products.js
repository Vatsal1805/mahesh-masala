...
export const products = [
  ...
  {
    id: 'teja-chillies',
    name: 'S17/Teja Chilly',
    category: 'whole',
    type: 'Whole Spices',
    image: tejaChillies,
    tagline: 'High-pungency, brilliant red whole Guntur Chilly.',
    description: 'Directly sourced from Guntur, Andhra Pradesh, our S17/Teja whole Chilly is highly sought after for its fierce heat and vibrant red color, serving as a vital ingredient for commercial spice grinding and export.',
  ...
  },
  {
    ...
    name: 'Kashmiri Chilly',
    category: 'whole',
    type: 'Whole Spices',
    image: kashmiriChillies,
    tagline: 'Vibrant crimson color with exceptionally mild heat.',
    description: 'Selected hand-picked whole Kashmiri Chilly that imparts a rich, royal red hue to food. Perfect for chefs and exporters looking to achieve visual brilliance without high spiciness.',
  ...
  },
  {
    ...
    name: 'Wonder Hot Chilly',
    category: 'whole',
    type: 'Whole Spices',
    image: wonderHotChillies,
    tagline: 'Bold flavor with medium-to-high pungency.',
    description: 'Wonder Hot Chilly features a thick, glossy crimson skin and a robust, well-rounded spicy flavor. Highly popular among commercial spice blenders.',
  ...
  },
  {
    ...
    name: 'All Type of Other Red Chilly',
    category: 'whole',
    type: 'Whole Spices',
    image: otherRedChillies,
    tagline: 'Custom trade options for diverse whole red Chilly varieties.',
    description: 'We source, clean, and grade any whole red Chilly variety including Byadgi, Guntur 334, and Sanam, customized to match domestic and international business specifications.',
  ...
  // --- POWDERED SPICES ---
  {
    ...
    name: 'Red Chilly Powder (Tezza Hot)',
    category: 'powdered',
    type: 'Powdered Spices',
    image: tezzaChilliPowder,
    tagline: 'Extra hot, pure authentic ground red chilly powder.',
    description: 'Processed from premium Teja red Chilly in our Nadiad facility. Ground using authentic traditional methods to retain its fiery pungency, color, and natural oils.',
  ...
  },
  {
    ...
    name: 'Red Chilly Powder (Teekha Laal)',
    category: 'powdered',
    type: 'Powdered Spices',
    image: teekhaLaalPowder,
    tagline: 'The perfect balance of moderate heat and rich red color.',
    description: 'A classic everyday red chilly powder designed to bring a pleasant warmth and deep crimson tint to all traditional Indian dishes.',
  ...
  },
  {
    ...
    name: 'Red Chilly Powder (Kashmiri Kumthi)',
    category: 'powdered',
    type: 'Powdered Spices',
    image: kashmiriKumthiPowder,
    tagline: 'Stunning crimson shade with very mild heat.',
    description: 'Authentically ground from premium Kashmiri Kumthi Chilly. Focuses on providing an exquisite ruby-red color to dishes while keeping the spice level highly accessible.',
  ...
  {
    id: 'maha-hot-powder',
    name: 'Red Chilly Powder (Maha Hot)',
    category: 'powdered',
    type: 'Powdered Spices',
    image: mahaHotPowder,
    tagline: 'Intensely hot red chilly powder for extreme spice.',
    description: 'For kitchens that require a massive spice impact. Carefully authentic ground from selected sharp chilly crops, yielding raw, fiery warmth with zero additives.',
