...
export const products = [
  ...
  {
    id: 'teja-chillies',
    name: 'S10/Teja Chillies',
    category: 'whole',
    type: 'Whole Spices',
    image: tejaChillies,
    tagline: 'High-pungency, brilliant red whole Guntur chillies.',
    description: 'Directly sourced from Guntur, Andhra Pradesh, our S10/Teja whole chillies are highly sought after for their fierce heat and vibrant red color, serving as a vital ingredient for commercial spice grinding and export.',
  ...
  // --- POWDERED SPICES ---
  {
    ...
    tagline: 'Extra hot, pure stone-ground red chilli powder.',
    description: 'Processed from premium Teja red chillies in our Nadiad facility. Ground at low temperatures to retain its fiery pungency, color, and natural oils.',
  ...
  },
  {
    ...
    description: 'Stone-milled from premium Kashmiri Kumthi chillies. Focuses on providing an exquisite ruby-red color to dishes while keeping the spice level highly accessible.',
  ...
  },
  {
    ...
    description: 'For kitchens that require a massive spice impact. Carefully stone-ground from selected sharp chilli crops, yielding raw, fiery warmth with zero additives.',
  ...
  },
  {
    ...
    description: 'Sun-dried whole turmeric from Sangli and Hingoli, ground at low temperatures in our Nadiad facility. Yields a rich golden color, high aroma, and natural curcumin benefits.',
  ...
  },
  {
    ...
    description: 'Made exclusively from dry-roasted, double-polished coriander seeds. Carefully stone-ground to release a citrus-toned flavor that forms the foundation of Indian gravies.',
